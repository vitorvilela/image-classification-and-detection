...
(X_train, y_train) = service.load_dataset('./npz/service_letters_train.npz') 
(X_test, y_test) = service.load_dataset('./npz/service_letters_test.npz') 
...
with open('./models/model_letters.json', 'w') as json_file:
...
# Checkpoint 
filepath = './models/model_letters.h5'
